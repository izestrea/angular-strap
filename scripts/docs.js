...
(function(window, document, undefined) {
  'use strict';
  angular.module('mgcrea.ngStrapDocs', [ 'mgcrea.ngStrap', 'mgcrea.ngPlunkr', 'ngRoute', 'ngAnimate' ]).constant('version', 'v2.2.3').config([ '$plunkrProvider', 'version', function($plunkrProvider, version) {
